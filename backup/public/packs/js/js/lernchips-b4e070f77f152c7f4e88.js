  ...
  this.init = function () {
    ...
    for (i = 0; i < acc.length; i++) {
      acc[i].addEventListener("click", function () {
        ...
        this.classList.toggle("active"); //             oldid=document.getElementById("folderid").getAttribute("value");
        ...
        showfoldernew(ch, tit.innerText); // 
      });
    }
  };
...
/******/ });
//# sourceMappingURL=lernchips-b4e070f77f152c7f4e88.js.map