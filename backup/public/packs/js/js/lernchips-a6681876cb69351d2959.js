  ...
  this.init = function () {
    ...
    for (i = 0; i < acc.length; i++) {
      acc[i].addEventListener("click", function () {
        ...
        console.log("neu");
        console.log(document.getElementById("folderid").getAttribute("value")); //create buttons
...
/******/ });
//# sourceMappingURL=lernchips-a6681876cb69351d2959.js.map