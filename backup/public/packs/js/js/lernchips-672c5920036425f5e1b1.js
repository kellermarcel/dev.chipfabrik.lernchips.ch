...
mobe.createOrdner = new function () {
  ...
  this.createFolder = function () {
    ...
    console.log("Folder erstellen");
    var element = document.getElementById("folderid").innerHTML;
    document.getElementById("folderid").innerHTML = str.replace(element, '4');
    var elementneu = document.getElementById("folderid").innerHTML;
    console.log(elementneu);
    var newBlanket = "\n            <div id=\"newBlanket\" class=\"new-blanket open\">\n                <div class=\"popup\">\n                  <span class=\"modal-close abbrechen\">&#43;</span>\n                    <h5 class=\"bl-title\">ordner erstellen</h5>\n                    <form id=\"myForm\" action=\"foldernew\">\n                      <p class=\"name-ordner\">\n                        <span class=\"folder-ico\"></span><input type=\"text\" name=\"nameOrdner\" id=\"nameOrdner\" value=\"\" placeholder=\"Neuer Ordner\">\n                         <p class=\"btn-ordner\">\n                            <a href=\"javascript:void(0);\" class=\"btn-small btn-red abbrechen\">Abbrechen</a>\n                            <input type=\"button\" class=\"btn-small btn-green erstellen\" onclick=\"myFunction()\" value=\"Erstellen\">\n                        </p>\n                    </form>\n                </div>\n            </div>";
...
/******/ });
//# sourceMappingURL=lernchips-672c5920036425f5e1b1.js.map